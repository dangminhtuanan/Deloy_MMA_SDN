      ...
      <DrawerContentScrollView {...props}>
        <View style={{ padding: 20, alignItems: "center", borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.15)", marginBottom: 10 }}>
          <Image
            ...
            resizeMode="contain"
          />
          <Text style={{ color: "#fff", fontSize: 18, fontWeight: "bold", marginTop: 12 }}>Staff Portal</Text>
        </View>
  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      ...
      >
        ...
        <Drawer.Screen name="low-stock" options={{ title: "Low Stock", drawerLabel: "Low Stock", drawerIcon: ({ color, size }) => <FontAwesome5 name="exclamation-triangle" color={color} size={size} /> }} />
      </Drawer>
