...
const C = { primary: "#0f766e", bg: "#F5F5F5", white: "#FFF", text: "#333", light: "#666", border: "#E8E8E8", blue: "#3b82f6", red: "#ef4444" };
    ...
    <View style={s.card}>
      ...
      <View style={s.actions}>
        <TouchableOpacity style={[s.actionBtn, { borderColor: C.blue }]} onPress={() => openEdit(item)}>
          <FontAwesome5 name="edit" size={13} color={C.blue} /><Text style={[s.actionBtnText, { color: C.blue }]}>Edit</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[s.actionBtn, { borderColor: C.red }]} onPress={() => handleDelete(item)}>
          <FontAwesome5 name="trash-alt" size={13} color={C.red} /><Text style={[s.actionBtnText, { color: C.red }]}>Delete</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
    ...
    <View style={s.container}>
      ...
      <View style={s.headerRow}>
        ...
        <TouchableOpacity style={s.addBtn} onPress={openAdd}>
          <FontAwesome5 name="plus" size={12} color={C.white} /><Text style={s.addText}>Add Category</Text>
        </TouchableOpacity>
      </View>
      {loading ? (
...
const s = StyleSheet.create({
  ...
  card: { backgroundColor: C.white, borderRadius: 12, padding: 16, marginBottom: 12, marginHorizontal: 12, elevation: 1 },
  ...
  modalContent: { backgroundColor: C.white, borderRadius: 16, padding: 20 },
